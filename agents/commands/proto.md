---
description: Iterative prototyping loop. Build a slice, validate it cheaply, show the human, fold feedback into the requirements, repeat. Ends by handing a requirements ledger to /yolo or killing the premise.
argument-hint: "[requirements, issue ID, or half-formed idea]"
---
