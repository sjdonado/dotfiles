...
```bash
PORT=$(jq -r .port '/Users/sjdonado/Library/Application Support/tldraw/server.json'); TOKEN=$(jq -r .token '/Users/sjdonado/Library/Application Support/tldraw/server.json')
