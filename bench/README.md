...
| route-bounded | 1 | fully specified ticket: the expensive route lands both stated behaviors in one pass. No task list is required: a one-step ticket does not owe one |
