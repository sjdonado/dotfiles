      ...
      vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function(event)
          vim.keymap.set(
            "n",
            "cc",
            "<cmd>DiffviewToggleFiles<CR><cmd>vertical Git commit<CR>",
            { buffer = event.buf, desc = "Toggle files and commit" }
          )
          vim.keymap.set(
            "n",
            "<Esc>",
            "<cmd>tabclose<CR>",
            { buffer = event.buf, desc = "Close tab" }
          )
          vim.keymap.set(
            "n",
            "q",
            "<cmd>DiffviewClose<CR>",
            { buffer = event.buf, desc = "Close Diff View" }
          )
        end,
      })
    end,
